...
When a track enters a high-velocity inflection zone cutting across the viewport, its structural width contracts via the Lorentz factor ($\gamma$). The shapes compress fluidly along their direction of motion, providing a direct visual representation of microarchitectural velocity.
